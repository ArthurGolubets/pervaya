        ...
        <div class="row w-100">
            <div class="col-12">
                <div class="route-back d-flex flex-wrap p-2 justify-content-between align-items-center">
                    <h5 class="ps-3 m-0">Обратная связь</h5>
            ...
            <div class="table-responsive px-2 w-100">
                <table class="table-collapse styled-table w-100 fs-7">
                    ...
                    <tr class="noselect">
                        ...
                        <td class="text-md-center">E-mail</td>
                    ...
                    <tbody>
                        @foreach($messageList as $item)
                            <tr>
                                ...
                                <td>{{$item->phone}}</td>
                                <td>{{$item->email}}</td>
                                <td width="200" class="text-center">{{$item->created_at->format('d.m.Y')}}</td>
                                <td width="100">
                                    <a href="#" wire:click.prevent="showModalOrder({{$item->id}})"><i class="fal fa-eye"></i></a>
                                    <a href="javascript:deleteItem({{$item->id}})" class="ms-2"><i class="fal fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content modal__bg">
                <div class="w-100 d-flex flex-column py-3 px-2">
                    ...
                    <div class="admin__modal-inner mt-2 d-flex align-items-center">
                        <span class="fs-6 text-gray pe-2">Email:</span>
                        <span class="fw-bolder fs-6 ml-2">{{$modal->email}}</span>
                    </div>

                    <div class="admin__modal-inner mt-2 d-flex align-items-center">
                        <span class="fs-6 text-gray d-block pe-2">Вопрос: <i>{{$modal->message}}</i></span>
                    </div>
                </div>
