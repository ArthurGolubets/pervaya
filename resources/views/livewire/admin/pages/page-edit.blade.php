            ...
            <div class="row g-0">
                ...
                <div class="row w-100">
                    <div class="col-12 my-3">
                        @if($isEditMode)
                            <livewire:admin.components.gallery :tname="$temp_id" :model-type="\App\Models\Page::class" is-edit="1" :model-id="$page->id"/>
                        @else
                            <livewire:admin.components.gallery :tname="$temp_id" :model-type="\App\Models\Page::class"/>
                        @endif
                    </div>
                </div>
